...
var controller = {
       ...
       var last = req.params.last;
        ...
        query.sort('-_id').exec((err, articles) =>{
            ...
            return res.status(500).send({
                status: 'error',
                message:'Error a devolver los articulos'
            });
    ...
    delete: (req, res) => {
        ...
        if(!articleRemoved){
            return res.status(404).send({
                status: 'error',
                message:'No de ha borrarado el articulo, posiblemente no exista'
            });
        }
            return res.status(200).send({
                status: 'success',
    ...
    upload: (req,res) => {
        ...
        //Conseguir nombre y la extension del archivoù
